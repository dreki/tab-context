...
import { fromChromeTab, fromClosedChromeTab, fromMostRecentClosedTab, ITab } from "../types/ITab";
...
chrome.tabs.onRemoved.addListener((tabId, removeInfo: chrome.tabs.TabRemoveInfo) => {
    ...
    const asyncFunction = async () => {
        const closedTabs = await TabCollection.loadClosedTabs(removeInfo.windowId);
